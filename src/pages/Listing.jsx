...
function Listing() {
  ...
  return <main>
<Swiper
      // per the Slider docs, declare the modules here for this Swiper component
      ...
      {listing.imageUrls.map( (url, index) => (
        <SwiperSlide key={index}>
          <div style={{
            ...
            minHeight: '20rem' // https://bit.ly/3HhxGUF
          }}
    ...
    <div className="listingDetails">
        ...
        <div className="leafletContainer">
            <MapContainer style={{height: '100%', width: '100%'}} center={[listing.geolocation.lat, listing.geolocation.lng]} zoom={13} scrollWheelZoom={false}>
              ...
              <Marker position={[listing.geolocation.lat, listing.geolocation.lng]}><Popup>
                {listing.location}
              </Popup></Marker>
            </MapContainer>
        </div>
